...
object StaticModellingGroups {
    val all = listOf(
            ...
            ModellingGroup("imperial", "Imperial College London", listOf(
                    ImpactEstimate(1, StaticScenarios.all.first(), "SuperModel 1.0", LocalDate.of(2017, Month.JANUARY, 15), StaticCountries.all, StaticData.defaultYears),
                    ImpactEstimate(2, StaticScenarios.all.first(), "SuperModel 1.1", LocalDate.of(2017, Month.JANUARY, 20), StaticCountries.all, StaticData.defaultYears),
                    ImpactEstimate(3, StaticScenarios.all.first(), "SuperModel 1.1", LocalDate.of(2017, Month.JANUARY, 21), StaticCountries.all, StaticData.defaultYears)
            ))
    )
}