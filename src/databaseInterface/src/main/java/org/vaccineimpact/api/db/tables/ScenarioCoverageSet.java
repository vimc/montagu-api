...
public class ScenarioCoverageSet extends TableImpl<ScenarioCoverageSetRecord> {
    ...
    private static final long serialVersionUID = 1153717626;
     ...
     */
    public final TableField<ScenarioCoverageSetRecord, Integer> ORDER = createField("order", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SCENARIO_COVERAGE_SET_PKEY);
    }
    ...
    public List<UniqueKey<ScenarioCoverageSetRecord>> getKeys() {
        return Arrays.<UniqueKey<ScenarioCoverageSetRecord>>asList(Keys.SCENARIO_COVERAGE_SET_PKEY, Keys.SCENARIO_COVERAGE_SET_SCENARIO_ORDER_KEY);
    }
