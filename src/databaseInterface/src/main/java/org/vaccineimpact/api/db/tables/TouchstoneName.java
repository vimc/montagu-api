...
public class TouchstoneName extends TableImpl<TouchstoneNameRecord> {
    ...
    private static final long serialVersionUID = 1408474989;
    ...
    private TouchstoneName(String alias, Table<TouchstoneNameRecord> aliased) {
        this(alias, aliased, null);
    }

    private TouchstoneName(String alias, Table<TouchstoneNameRecord> aliased, Field<?>[] parameters) {
