...
public class ModelRunParameter extends TableImpl<ModelRunParameterRecord> {
    ...
    private ModelRunParameter(String alias, Table<ModelRunParameterRecord> aliased) {
        this(alias, aliased, null);
    }

    private ModelRunParameter(String alias, Table<ModelRunParameterRecord> aliased, Field<?>[] parameters) {
