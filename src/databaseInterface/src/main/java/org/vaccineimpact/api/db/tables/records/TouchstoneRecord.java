...
public class TouchstoneRecord extends UpdatableRecordImpl<TouchstoneRecord> implements Record7<String, String, Integer, String, String, Integer, Integer> {

    private static final long serialVersionUID = 1590595120;
     ...
     */
    @Override
    public Row7<String, String, Integer, String, String, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row7<String, String, Integer, String, String, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public TouchstoneRecord values(String value1, String value2, Integer value3, String value4, String value5, Integer value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TouchstoneRecord(String id, String touchstoneName, Integer version, String description, String status, Integer yearStart, Integer yearEnd) {
        super(Touchstone.TOUCHSTONE);
