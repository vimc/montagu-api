...
public class CountryRecord extends UpdatableRecordImpl<CountryRecord> implements Record3<String, String, Integer> {

    private static final long serialVersionUID = 1653832667;
     ...
     */
    @Override
    public CountryRecord value3(Integer value) {
        setNid(value);
        return this;
    }
     ...
     */
    @Override
    public CountryRecord values(String value1, String value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public CountryRecord(String id, String name, Integer nid) {
        super(Country.COUNTRY);
