...
public class DemographicSource extends TableImpl<DemographicSourceRecord> {
    ...
    private static final long serialVersionUID = 1180681190;
    ...
    private DemographicSource(String alias, Table<DemographicSourceRecord> aliased) {
        this(alias, aliased, null);
    }

    private DemographicSource(String alias, Table<DemographicSourceRecord> aliased, Field<?>[] parameters) {
