...
public class ModelRunParameterValue extends TableImpl<ModelRunParameterValueRecord> {
    ...
    private static final long serialVersionUID = 1647259626;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.MODEL_RUN_PARAMETER_VALUE_MODEL_RUN_PARAMETER_MODEL_RUN_KEY, Indexes.MODEL_RUN_PARAMETER_VALUE_PKEY);
    }
