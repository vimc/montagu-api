...
public class ResponsibilityRecord extends UpdatableRecordImpl<ResponsibilityRecord> implements Record5<Integer, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = 116640918;
     ...
     */
    @Override
    public ResponsibilityRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ResponsibilityRecord(Integer id, Integer responsibilitySet, Integer scenario, Integer currentBurdenEstimateSet, Integer currentStochasticBurdenEstimateSet) {
        super(Responsibility.RESPONSIBILITY);
