...
public class DemographicValueUnit extends TableImpl<DemographicValueUnitRecord> {
    ...
    private static final long serialVersionUID = -346733048;
    ...
    public DemographicValueUnit() {
        this("demographic_value_unit", null);
    }
    ...
    private DemographicValueUnit(String alias, Table<DemographicValueUnitRecord> aliased) {
        this(alias, aliased, null);
    }

    private DemographicValueUnit(String alias, Table<DemographicValueUnitRecord> aliased, Field<?>[] parameters) {
