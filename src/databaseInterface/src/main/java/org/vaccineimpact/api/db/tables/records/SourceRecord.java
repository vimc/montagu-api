...
public class SourceRecord extends UpdatableRecordImpl<SourceRecord> implements Record2<String, String> {

    private static final long serialVersionUID = -408472460;
     ...
     */
    @Override
    public SourceRecord value1(String value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public SourceRecord values(String value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public SourceRecord(String id, String name) {
        super(Source.SOURCE);
