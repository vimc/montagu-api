...
public class DisabilityWeight extends TableImpl<DisabilityWeightRecord> {
    ...
    private static final long serialVersionUID = -212344370;
    ...
    private DisabilityWeight(String alias, Table<DisabilityWeightRecord> aliased) {
        this(alias, aliased, null);
    }

    private DisabilityWeight(String alias, Table<DisabilityWeightRecord> aliased, Field<?>[] parameters) {
