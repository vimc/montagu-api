...
public class SelectBurdenDataCol extends TableImpl<SelectBurdenDataColRecord> {
    ...
    private static final long serialVersionUID = -584955442;
    ...
    public SelectBurdenDataCol() {
        this("select_burden_data_col", null);
    }
    ...
    private SelectBurdenDataCol(String alias, Table<SelectBurdenDataColRecord> aliased) {
        this(alias, aliased, new Field[2]);
    }

    private SelectBurdenDataCol(String alias, Table<SelectBurdenDataColRecord> aliased, Field<?>[] parameters) {
    ...
    public SelectBurdenDataCol call(Integer setId, Integer outcomeId) {
        return new SelectBurdenDataCol(getName(), null, new Field[] { DSL.val(setId), DSL.val(outcomeId) });
    }
    ...
    public SelectBurdenDataCol call(Field<Integer> setId, Field<Integer> outcomeId) {
        return new SelectBurdenDataCol(getName(), null, new Field[] { setId, outcomeId });
    }
}
