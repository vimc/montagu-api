...
public class ModelRunParameterSet extends TableImpl<ModelRunParameterSetRecord> {
    ...
    private static final long serialVersionUID = 774499402;
    ...
    public ModelRunParameterSet() {
        this("model_run_parameter_set", null);
    }
    ...
    private ModelRunParameterSet(String alias, Table<ModelRunParameterSetRecord> aliased) {
        this(alias, aliased, null);
    }

    private ModelRunParameterSet(String alias, Table<ModelRunParameterSetRecord> aliased, Field<?>[] parameters) {
