...
public class CountryMetadata extends TableImpl<CountryMetadataRecord> {
    ...
    private CountryMetadata(String alias, Table<CountryMetadataRecord> aliased) {
        this(alias, aliased, null);
    }

    private CountryMetadata(String alias, Table<CountryMetadataRecord> aliased, Field<?>[] parameters) {
