...
public class ImpactOutcome extends TableImpl<ImpactOutcomeRecord> {
    ...
    private static final long serialVersionUID = 2143893848;
    ...
    private ImpactOutcome(String alias, Table<ImpactOutcomeRecord> aliased) {
        this(alias, aliased, null);
    }

    private ImpactOutcome(String alias, Table<ImpactOutcomeRecord> aliased, Field<?>[] parameters) {
