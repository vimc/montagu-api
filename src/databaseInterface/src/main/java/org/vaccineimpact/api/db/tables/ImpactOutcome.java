...
public class ImpactOutcome extends TableImpl<ImpactOutcomeRecord> {
     ...
     */
    public final TableField<ImpactOutcomeRecord, String> ID = createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.impact_outcome.name</code>.
     */
    public final TableField<ImpactOutcomeRecord, String> NAME = createField(DSL.name("name"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    public <O extends Record> ImpactOutcome(Table<O> child, ForeignKey<O, ImpactOutcomeRecord> key) {
        super(child, key, IMPACT_OUTCOME);
    }
