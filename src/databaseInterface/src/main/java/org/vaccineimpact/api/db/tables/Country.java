...
public class Country extends TableImpl<CountryRecord> {
     ...
     */
    public final TableField<CountryRecord, String> ID = createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");
     ...
     */
    public final TableField<CountryRecord, Short> NID = createField(DSL.name("nid"), SQLDataType.SMALLINT, this, "");
    ...
    public List<UniqueKey<CountryRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.COUNTRY_NID_UNIQUE);
    }
