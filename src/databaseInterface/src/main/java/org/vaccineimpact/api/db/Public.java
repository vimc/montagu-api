...
public class Public extends SchemaImpl {
     ...
     */
    public final ApiAccessLog API_ACCESS_LOG = ApiAccessLog.API_ACCESS_LOG;
     ...
     */
    public final Burden BURDEN = Burden.BURDEN;

    /**
     * The table <code>public.burden_all</code>.
     */
    public final BurdenAll BURDEN_ALL = BurdenAll.BURDEN_ALL;

    /**
     * The table <code>public.burden_estimate</code>.
     */
    public final BurdenEstimate BURDEN_ESTIMATE = BurdenEstimate.BURDEN_ESTIMATE;

    /**
     * The table <code>public.burden_estimate_country_expectation</code>.
     */
    public final BurdenEstimateCountryExpectation BURDEN_ESTIMATE_COUNTRY_EXPECTATION = BurdenEstimateCountryExpectation.BURDEN_ESTIMATE_COUNTRY_EXPECTATION;
     ...
     */
    public final BurdenEstimateExpectation BURDEN_ESTIMATE_EXPECTATION = BurdenEstimateExpectation.BURDEN_ESTIMATE_EXPECTATION;

    /**
     * The table <code>public.burden_estimate_outcome_expectation</code>.
     */
    public final BurdenEstimateOutcomeExpectation BURDEN_ESTIMATE_OUTCOME_EXPECTATION = BurdenEstimateOutcomeExpectation.BURDEN_ESTIMATE_OUTCOME_EXPECTATION;

    /**
     * The table <code>public.burden_estimate_set</code>.
     */
    public final BurdenEstimateSet BURDEN_ESTIMATE_SET = BurdenEstimateSet.BURDEN_ESTIMATE_SET;

    /**
     * The table <code>public.burden_estimate_set_problem</code>.
     */
    public final BurdenEstimateSetProblem BURDEN_ESTIMATE_SET_PROBLEM = BurdenEstimateSetProblem.BURDEN_ESTIMATE_SET_PROBLEM;

    /**
     * The table <code>public.burden_estimate_set_status</code>.
     */
    public final BurdenEstimateSetStatus BURDEN_ESTIMATE_SET_STATUS = BurdenEstimateSetStatus.BURDEN_ESTIMATE_SET_STATUS;

    /**
     * The table <code>public.burden_estimate_set_type</code>.
     */
    public final BurdenEstimateSetType BURDEN_ESTIMATE_SET_TYPE = BurdenEstimateSetType.BURDEN_ESTIMATE_SET_TYPE;

    /**
     * The table <code>public.burden_outcome</code>.
     */
    public final BurdenOutcome BURDEN_OUTCOME = BurdenOutcome.BURDEN_OUTCOME;

    /**
     * The table <code>public.cofinance_status</code>.
     */
    public final CofinanceStatus COFINANCE_STATUS = CofinanceStatus.COFINANCE_STATUS;

    /**
     * The table <code>public.connectby</code>.
     */
    public final Connectby CONNECTBY = Connectby.CONNECTBY;
     ...
     */
    public final CountryCofinance COUNTRY_COFINANCE = CountryCofinance.COUNTRY_COFINANCE;

    /**
     * The table <code>public.country_disease_endemic</code>.
     */
    public final CountryDiseaseEndemic COUNTRY_DISEASE_ENDEMIC = CountryDiseaseEndemic.COUNTRY_DISEASE_ENDEMIC;

    /**
     * The table <code>public.country_fragility</code>.
     */
    public final CountryFragility COUNTRY_FRAGILITY = CountryFragility.COUNTRY_FRAGILITY;

    /**
     * The table <code>public.country_metadata</code>.
     */
    public final CountryMetadata COUNTRY_METADATA = CountryMetadata.COUNTRY_METADATA;

    /**
     * The table <code>public.country_vaccine_metadata</code>.
     */
    public final CountryVaccineMetadata COUNTRY_VACCINE_METADATA = CountryVaccineMetadata.COUNTRY_VACCINE_METADATA;

    /**
     * The table <code>public.country_worldbank_status</code>.
     */
    public final CountryWorldbankStatus COUNTRY_WORLDBANK_STATUS = CountryWorldbankStatus.COUNTRY_WORLDBANK_STATUS;

    /**
     * The table <code>public.coverage</code>.
     */
    public final Coverage COVERAGE = Coverage.COVERAGE;

    /**
     * The table <code>public.coverage_set</code>.
     */
    public final CoverageSet COVERAGE_SET = CoverageSet.COVERAGE_SET;

    /**
     * The table <code>public.coverage_set_upload_metadata</code>.
     */
    public final CoverageSetUploadMetadata COVERAGE_SET_UPLOAD_METADATA = CoverageSetUploadMetadata.COVERAGE_SET_UPLOAD_METADATA;

    /**
     * The table <code>public.crosstab</code>.
     */
    public final Crosstab CROSSTAB = Crosstab.CROSSTAB;
     ...
     */
    public final Crosstab2 CROSSTAB2 = Crosstab2.CROSSTAB2;
     ...
     */
    public final Crosstab3 CROSSTAB3 = Crosstab3.CROSSTAB3;
     ...
     */
    public final Crosstab4 CROSSTAB4 = Crosstab4.CROSSTAB4;
     ...
     */
    public final DemographicDataset DEMOGRAPHIC_DATASET = DemographicDataset.DEMOGRAPHIC_DATASET;

    /**
     * The table <code>public.demographic_source</code>.
     */
    public final DemographicSource DEMOGRAPHIC_SOURCE = DemographicSource.DEMOGRAPHIC_SOURCE;

    /**
     * The table <code>public.demographic_statistic</code>.
     */
    public final DemographicStatistic DEMOGRAPHIC_STATISTIC = DemographicStatistic.DEMOGRAPHIC_STATISTIC;

    /**
     * The table <code>public.demographic_statistic_type</code>.
     */
    public final DemographicStatisticType DEMOGRAPHIC_STATISTIC_TYPE = DemographicStatisticType.DEMOGRAPHIC_STATISTIC_TYPE;

    /**
     * The table <code>public.demographic_statistic_type_variant</code>.
     */
    public final DemographicStatisticTypeVariant DEMOGRAPHIC_STATISTIC_TYPE_VARIANT = DemographicStatisticTypeVariant.DEMOGRAPHIC_STATISTIC_TYPE_VARIANT;

    /**
     * The table <code>public.demographic_subnational_statistic</code>.
     */
    public final DemographicSubnationalStatistic DEMOGRAPHIC_SUBNATIONAL_STATISTIC = DemographicSubnationalStatistic.DEMOGRAPHIC_SUBNATIONAL_STATISTIC;

    /**
     * The table <code>public.demographic_value_unit</code>.
     */
    public final DemographicValueUnit DEMOGRAPHIC_VALUE_UNIT = DemographicValueUnit.DEMOGRAPHIC_VALUE_UNIT;

    /**
     * The table <code>public.demographic_variant</code>.
     */
    public final DemographicVariant DEMOGRAPHIC_VARIANT = DemographicVariant.DEMOGRAPHIC_VARIANT;

    /**
     * The table <code>public.disability_weight</code>.
     */
    public final DisabilityWeight DISABILITY_WEIGHT = DisabilityWeight.DISABILITY_WEIGHT;
     ...
     */
    public final FrancophoneStatus FRANCOPHONE_STATUS = FrancophoneStatus.FRANCOPHONE_STATUS;

    /**
     * The table <code>public.gavi_eligibility</code>.
     */
    public final GaviEligibility GAVI_ELIGIBILITY = GaviEligibility.GAVI_ELIGIBILITY;

    /**
     * The table <code>public.gavi_eligibility_status</code>.
     */
    public final GaviEligibilityStatus GAVI_ELIGIBILITY_STATUS = GaviEligibilityStatus.GAVI_ELIGIBILITY_STATUS;

    /**
     * The table <code>public.gavi_focal_model</code>.
     */
    public final GaviFocalModel GAVI_FOCAL_MODEL = GaviFocalModel.GAVI_FOCAL_MODEL;

    /**
     * include four types of gavi region interested by gavi donors
     */
    public final GaviRegion GAVI_REGION = GaviRegion.GAVI_REGION;
     ...
     */
    public final GaviSupportLevel GAVI_SUPPORT_LEVEL = GaviSupportLevel.GAVI_SUPPORT_LEVEL;
     ...
     */
    public final ImpactEstimate IMPACT_ESTIMATE = ImpactEstimate.IMPACT_ESTIMATE;

    /**
     * The table <code>public.impact_estimate_ingredient</code>.
     */
    public final ImpactEstimateIngredient IMPACT_ESTIMATE_INGREDIENT = ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT;

    /**
     * The table <code>public.impact_estimate_recipe</code>.
     */
    public final ImpactEstimateRecipe IMPACT_ESTIMATE_RECIPE = ImpactEstimateRecipe.IMPACT_ESTIMATE_RECIPE;

    /**
     * The table <code>public.impact_estimate_set</code>.
     */
    public final ImpactEstimateSet IMPACT_ESTIMATE_SET = ImpactEstimateSet.IMPACT_ESTIMATE_SET;

    /**
     * The table <code>public.impact_estimate_set_ingredient</code>.
     */
    public final ImpactEstimateSetIngredient IMPACT_ESTIMATE_SET_INGREDIENT = ImpactEstimateSetIngredient.IMPACT_ESTIMATE_SET_INGREDIENT;

    /**
     * The table <code>public.impact_outcome</code>.
     */
    public final ImpactOutcome IMPACT_OUTCOME = ImpactOutcome.IMPACT_OUTCOME;

    /**
     * The table <code>public.legal_agreement</code>.
     */
    public final LegalAgreement LEGAL_AGREEMENT = LegalAgreement.LEGAL_AGREEMENT;
     ...
     */
    public final ModelRunParameter MODEL_RUN_PARAMETER = ModelRunParameter.MODEL_RUN_PARAMETER;

    /**
     * The table <code>public.model_run_parameter_set</code>.
     */
    public final ModelRunParameterSet MODEL_RUN_PARAMETER_SET = ModelRunParameterSet.MODEL_RUN_PARAMETER_SET;

    /**
     * The table <code>public.model_run_parameter_value</code>.
     */
    public final ModelRunParameterValue MODEL_RUN_PARAMETER_VALUE = ModelRunParameterValue.MODEL_RUN_PARAMETER_VALUE;
     ...
     */
    public final ModelVersionCountry MODEL_VERSION_COUNTRY = ModelVersionCountry.MODEL_VERSION_COUNTRY;
     ...
     * `current` as `null`.
     */
    public final ModellingGroup MODELLING_GROUP = ModellingGroup.MODELLING_GROUP;

    /**
     * The table <code>public.normal_rand</code>.
     */
    public final NormalRand NORMAL_RAND = NormalRand.NORMAL_RAND;
     ...
     */
    public final RegionSubnational REGION_SUBNATIONAL = RegionSubnational.REGION_SUBNATIONAL;
     ...
     */
    public final ResponsibilityComment RESPONSIBILITY_COMMENT = ResponsibilityComment.RESPONSIBILITY_COMMENT;

    /**
     * The table <code>public.responsibility_set</code>.
     */
    public final ResponsibilitySet RESPONSIBILITY_SET = ResponsibilitySet.RESPONSIBILITY_SET;

    /**
     * The table <code>public.responsibility_set_comment</code>.
     */
    public final ResponsibilitySetComment RESPONSIBILITY_SET_COMMENT = ResponsibilitySetComment.RESPONSIBILITY_SET_COMMENT;

    /**
     * Possible values {incomplete, submitted, approved}
     */
    public final ResponsibilitySetStatus RESPONSIBILITY_SET_STATUS = ResponsibilitySetStatus.RESPONSIBILITY_SET_STATUS;
     ...
     */
    public final ScenarioCoverageSet SCENARIO_COVERAGE_SET = ScenarioCoverageSet.SCENARIO_COVERAGE_SET;

    /**
     * The table <code>public.scenario_description</code>.
     */
    public final ScenarioDescription SCENARIO_DESCRIPTION = ScenarioDescription.SCENARIO_DESCRIPTION;

    /**
     * The table <code>public.scenario_type</code>.
     */
    public final ScenarioType SCENARIO_TYPE = ScenarioType.SCENARIO_TYPE;

    /**
     * The table <code>public.select_burden_data1</code>.
     */
    public final SelectBurdenData1 SELECT_BURDEN_DATA1 = SelectBurdenData1.SELECT_BURDEN_DATA1;
     ...
     */
    public final SelectBurdenData2 SELECT_BURDEN_DATA2 = SelectBurdenData2.SELECT_BURDEN_DATA2;
     ...
     */
    public final SelectBurdenData3 SELECT_BURDEN_DATA3 = SelectBurdenData3.SELECT_BURDEN_DATA3;
     ...
     */
    public final SelectBurdenData4 SELECT_BURDEN_DATA4 = SelectBurdenData4.SELECT_BURDEN_DATA4;
     ...
     */
    public final SelectBurdenData5 SELECT_BURDEN_DATA5 = SelectBurdenData5.SELECT_BURDEN_DATA5;
     ...
     */
    public final SelectBurdenData6 SELECT_BURDEN_DATA6 = SelectBurdenData6.SELECT_BURDEN_DATA6;
     ...
     */
    public final SelectBurdenData7 SELECT_BURDEN_DATA7 = SelectBurdenData7.SELECT_BURDEN_DATA7;
     ...
     */
    public final SelectBurdenData8 SELECT_BURDEN_DATA8 = SelectBurdenData8.SELECT_BURDEN_DATA8;
     ...
     */
    public final SelectBurdenDataCol SELECT_BURDEN_DATA_COL = SelectBurdenDataCol.SELECT_BURDEN_DATA_COL;
     ...
     */
    public final SupportType SUPPORT_TYPE = SupportType.SUPPORT_TYPE;
     ...
     */
    public final Touchstone TOUCHSTONE = Touchstone.TOUCHSTONE;

    /**
     * The table <code>public.touchstone_country</code>.
     */
    public final TouchstoneCountry TOUCHSTONE_COUNTRY = TouchstoneCountry.TOUCHSTONE_COUNTRY;

    /**
     * The table <code>public.touchstone_demographic_dataset</code>.
     */
    public final TouchstoneDemographicDataset TOUCHSTONE_DEMOGRAPHIC_DATASET = TouchstoneDemographicDataset.TOUCHSTONE_DEMOGRAPHIC_DATASET;

    /**
     * The table <code>public.touchstone_demographic_source</code>.
     */
    public final TouchstoneDemographicSource TOUCHSTONE_DEMOGRAPHIC_SOURCE = TouchstoneDemographicSource.TOUCHSTONE_DEMOGRAPHIC_SOURCE;

    /**
     * The table <code>public.touchstone_name</code>.
     */
    public final TouchstoneName TOUCHSTONE_NAME = TouchstoneName.TOUCHSTONE_NAME;

    /**
     * Valid values: {in-preparation, open, finished}
     */
    public final TouchstoneStatus TOUCHSTONE_STATUS = TouchstoneStatus.TOUCHSTONE_STATUS;

    /**
     * The table <code>public.touchstone_years</code>.
     */
    public final TouchstoneYears TOUCHSTONE_YEARS = TouchstoneYears.TOUCHSTONE_YEARS;

    /**
     * The table <code>public.upload_info</code>.
     */
    public final UploadInfo UPLOAD_INFO = UploadInfo.UPLOAD_INFO;
     ...
     */
    public final UserLegalAgreement USER_LEGAL_AGREEMENT = UserLegalAgreement.USER_LEGAL_AGREEMENT;

    /**
     * The table <code>public.v_coverage_info</code>.
     */
    public final VCoverageInfo V_COVERAGE_INFO = VCoverageInfo.V_COVERAGE_INFO;

    /**
     * The table <code>public.v_responsibility_info</code>.
     */
    public final VResponsibilityInfo V_RESPONSIBILITY_INFO = VResponsibilityInfo.V_RESPONSIBILITY_INFO;

    /**
     * The table <code>public.vaccine</code>.
     */
    public final Vaccine VACCINE = Vaccine.VACCINE;

    /**
     * The table <code>public.vaccine_routine_age</code>.
     */
    public final VaccineRoutineAge VACCINE_ROUTINE_AGE = VaccineRoutineAge.VACCINE_ROUTINE_AGE;

    /**
     * Status within BMGF vxdel country classifiecation
     */
    public final VxdelSegment VXDEL_SEGMENT = VxdelSegment.VXDEL_SEGMENT;

    /**
     * Country development status according to the worldbank
     */
    public final WorldbankStatus WORLDBANK_STATUS = WorldbankStatus.WORLDBANK_STATUS;
    ...
    public final List<UDT<?>> getUDTs() {
        return Arrays.asList(
            TablefuncCrosstab_2.TABLEFUNC_CROSSTAB_2,
            TablefuncCrosstab_3.TABLEFUNC_CROSSTAB_3,
            TablefuncCrosstab_4.TABLEFUNC_CROSSTAB_4
        );
    }
}
