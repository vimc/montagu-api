...
public class Scenario extends TableImpl<ScenarioRecord> {
    ...
    private static final long serialVersionUID = -1158870221;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SCENARIO_PKEY, Indexes.SCENARIO_TOUCHSTONE_SCENARIO_DESCRIPTION_KEY);
    }
