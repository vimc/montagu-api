...
public class TouchstoneDemographicDataset extends TableImpl<TouchstoneDemographicDatasetRecord> {
    ...
    private static final long serialVersionUID = 1857348597;
    ...
    public TouchstoneDemographicDataset() {
        this("touchstone_demographic_dataset", null);
    }
    ...
    private TouchstoneDemographicDataset(String alias, Table<TouchstoneDemographicDatasetRecord> aliased) {
        this(alias, aliased, null);
    }

    private TouchstoneDemographicDataset(String alias, Table<TouchstoneDemographicDatasetRecord> aliased, Field<?>[] parameters) {
