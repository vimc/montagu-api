...
public class BurdenEstimateRecord extends TableRecordImpl<BurdenEstimateRecord> implements Record7<Integer, Short, Short, Short, Float, Short, Integer> {

    private static final long serialVersionUID = -959677073;
