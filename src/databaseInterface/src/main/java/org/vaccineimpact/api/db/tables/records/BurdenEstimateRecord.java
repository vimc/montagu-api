...
public class BurdenEstimateRecord extends UpdatableRecordImpl<BurdenEstimateRecord> implements Record8<Integer, Integer, String, Integer, Integer, BigDecimal, Integer, Integer> {

    private static final long serialVersionUID = -1946107976;
     ...
     */
    @Override
    public Row8<Integer, Integer, String, Integer, Integer, BigDecimal, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, String, Integer, Integer, BigDecimal, Integer, Integer> valuesRow() {
     ...
     */
    @Override
    public BurdenEstimateRecord values(Integer value1, Integer value2, String value3, Integer value4, Integer value5, BigDecimal value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BurdenEstimateRecord(Integer id, Integer burdenEstimateSet, String country, Integer year, Integer burdenOutcome, BigDecimal value, Integer age, Integer modelRun) {
        super(BurdenEstimate.BURDEN_ESTIMATE);
