...
public class BurdenOutcomeRecord extends UpdatableRecordImpl<BurdenOutcomeRecord> implements Record3<Integer, String, String> {

    private static final long serialVersionUID = -570608213;
     ...
     */
    @Override
    public BurdenOutcomeRecord values(Integer value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public BurdenOutcomeRecord(Integer id, String code, String name) {
        super(BurdenOutcome.BURDEN_OUTCOME);
