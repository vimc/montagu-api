...
public class ApiAccessLogRecord extends UpdatableRecordImpl<ApiAccessLogRecord> implements Record5<Integer, String, Timestamp, String, Integer> {

    private static final long serialVersionUID = 494852744;
     ...
     */
    @Override
    public ApiAccessLogRecord values(Integer value1, String value2, Timestamp value3, String value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ApiAccessLogRecord(Integer id, String who, Timestamp when, String what, Integer result) {
        super(ApiAccessLog.API_ACCESS_LOG);
