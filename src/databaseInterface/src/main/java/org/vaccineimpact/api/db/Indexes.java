...
public class Indexes {
    ...
    private static class Indexes0 extends AbstractKeys {
        public static Index ACTIVITY_TYPE_PKEY = createIndex("activity_type_pkey", ActivityType.ACTIVITY_TYPE, new OrderField[] { ActivityType.ACTIVITY_TYPE.ID }, true);
        public static Index API_ACCESS_LOG_IP_ADDRESS_IDX = createIndex("api_access_log_ip_address_idx", ApiAccessLog.API_ACCESS_LOG, new OrderField[] { ApiAccessLog.API_ACCESS_LOG.IP_ADDRESS }, false);
        public static Index API_ACCESS_LOG_PKEY = createIndex("api_access_log_pkey", ApiAccessLog.API_ACCESS_LOG, new OrderField[] { ApiAccessLog.API_ACCESS_LOG.ID }, true);
        public static Index API_ACCESS_LOG_RESULT_IDX = createIndex("api_access_log_result_idx", ApiAccessLog.API_ACCESS_LOG, new OrderField[] { ApiAccessLog.API_ACCESS_LOG.RESULT }, false);
        public static Index API_ACCESS_LOG_WHAT_IDX = createIndex("api_access_log_what_idx", ApiAccessLog.API_ACCESS_LOG, new OrderField[] { ApiAccessLog.API_ACCESS_LOG.WHAT }, false);
        public static Index API_ACCESS_LOG_WHO_IDX = createIndex("api_access_log_who_idx", ApiAccessLog.API_ACCESS_LOG, new OrderField[] { ApiAccessLog.API_ACCESS_LOG.WHO }, false);
        public static Index APP_USER_PKEY = createIndex("app_user_pkey", AppUser.APP_USER, new OrderField[] { AppUser.APP_USER.USERNAME }, true);
        public static Index BURDEN_ESTIMATE_BURDEN_ESTIMATE_SET_IDX = createIndex("burden_estimate_burden_estimate_set_idx", BurdenEstimate.BURDEN_ESTIMATE, new OrderField[] { BurdenEstimate.BURDEN_ESTIMATE.BURDEN_ESTIMATE_SET }, false);
        public static Index BURDEN_ESTIMATE_PKEY = createIndex("burden_estimate_pkey", BurdenEstimate.BURDEN_ESTIMATE, new OrderField[] { BurdenEstimate.BURDEN_ESTIMATE.ID }, true);
        public static Index BURDEN_ESTIMATE_UNIQUE = createIndex("burden_estimate_unique", BurdenEstimate.BURDEN_ESTIMATE, new OrderField[] { BurdenEstimate.BURDEN_ESTIMATE.BURDEN_ESTIMATE_SET, BurdenEstimate.BURDEN_ESTIMATE.COUNTRY, BurdenEstimate.BURDEN_ESTIMATE.YEAR, BurdenEstimate.BURDEN_ESTIMATE.AGE, BurdenEstimate.BURDEN_ESTIMATE.BURDEN_OUTCOME }, true);
        public static Index BURDEN_ESTIMATE_SET_PKEY = createIndex("burden_estimate_set_pkey", BurdenEstimateSet.BURDEN_ESTIMATE_SET, new OrderField[] { BurdenEstimateSet.BURDEN_ESTIMATE_SET.ID }, true);
        public static Index BURDEN_ESTIMATE_SET_PROBLEM_PKEY = createIndex("burden_estimate_set_problem_pkey", BurdenEstimateSetProblem.BURDEN_ESTIMATE_SET_PROBLEM, new OrderField[] { BurdenEstimateSetProblem.BURDEN_ESTIMATE_SET_PROBLEM.ID }, true);
        public static Index BURDEN_ESTIMATE_SET_STATUS_PKEY = createIndex("burden_estimate_set_status_pkey", BurdenEstimateSetStatus.BURDEN_ESTIMATE_SET_STATUS, new OrderField[] { BurdenEstimateSetStatus.BURDEN_ESTIMATE_SET_STATUS.CODE }, true);
        public static Index BURDEN_ESTIMATE_SET_TYPE_PKEY = createIndex("burden_estimate_set_type_pkey", BurdenEstimateSetType.BURDEN_ESTIMATE_SET_TYPE, new OrderField[] { BurdenEstimateSetType.BURDEN_ESTIMATE_SET_TYPE.CODE }, true);
        public static Index BURDEN_OUTCOME_CODE_KEY = createIndex("burden_outcome_code_key", BurdenOutcome.BURDEN_OUTCOME, new OrderField[] { BurdenOutcome.BURDEN_OUTCOME.CODE }, true);
        public static Index BURDEN_OUTCOME_PKEY = createIndex("burden_outcome_pkey", BurdenOutcome.BURDEN_OUTCOME, new OrderField[] { BurdenOutcome.BURDEN_OUTCOME.ID }, true);
        public static Index COUNTRY_PKEY = createIndex("country_pkey", Country.COUNTRY, new OrderField[] { Country.COUNTRY.ID }, true);
        public static Index COUNTRY_METADATA_PKEY = createIndex("country_metadata_pkey", CountryMetadata.COUNTRY_METADATA, new OrderField[] { CountryMetadata.COUNTRY_METADATA.ID }, true);
        public static Index COUNTRY_VACCINE_METADATA_PKEY = createIndex("country_vaccine_metadata_pkey", CountryVaccineMetadata.COUNTRY_VACCINE_METADATA, new OrderField[] { CountryVaccineMetadata.COUNTRY_VACCINE_METADATA.ID }, true);
        public static Index COVERAGE_PKEY = createIndex("coverage_pkey", Coverage.COVERAGE, new OrderField[] { Coverage.COVERAGE.ID }, true);
        public static Index COVERAGE_SET_PKEY = createIndex("coverage_set_pkey", CoverageSet.COVERAGE_SET, new OrderField[] { CoverageSet.COVERAGE_SET.ID }, true);
        public static Index DEMOGRAPHIC_DATASET_PKEY = createIndex("demographic_dataset_pkey", DemographicDataset.DEMOGRAPHIC_DATASET, new OrderField[] { DemographicDataset.DEMOGRAPHIC_DATASET.ID }, true);
        public static Index DEMOGRAPHIC_SOURCE_PKEY = createIndex("demographic_source_pkey", DemographicSource.DEMOGRAPHIC_SOURCE, new OrderField[] { DemographicSource.DEMOGRAPHIC_SOURCE.ID }, true);
        public static Index DEMOGRAPHIC_STATISTIC_COUNTRY_IDX = createIndex("demographic_statistic_country_idx", DemographicStatistic.DEMOGRAPHIC_STATISTIC, new OrderField[] { DemographicStatistic.DEMOGRAPHIC_STATISTIC.COUNTRY }, false);
        public static Index DEMOGRAPHIC_STATISTIC_DEMOGRAPHIC_SOURCE_IDX = createIndex("demographic_statistic_demographic_source_idx", DemographicStatistic.DEMOGRAPHIC_STATISTIC, new OrderField[] { DemographicStatistic.DEMOGRAPHIC_STATISTIC.DEMOGRAPHIC_SOURCE }, false);
        public static Index DEMOGRAPHIC_STATISTIC_DEMOGRAPHIC_STATISTIC_TYPE_IDX = createIndex("demographic_statistic_demographic_statistic_type_idx", DemographicStatistic.DEMOGRAPHIC_STATISTIC, new OrderField[] { DemographicStatistic.DEMOGRAPHIC_STATISTIC.DEMOGRAPHIC_STATISTIC_TYPE }, false);
        public static Index DEMOGRAPHIC_STATISTIC_DEMOGRAPHIC_VARIANT_IDX = createIndex("demographic_statistic_demographic_variant_idx", DemographicStatistic.DEMOGRAPHIC_STATISTIC, new OrderField[] { DemographicStatistic.DEMOGRAPHIC_STATISTIC.DEMOGRAPHIC_VARIANT }, false);
        public static Index DEMOGRAPHIC_STATISTIC_GENDER_IDX = createIndex("demographic_statistic_gender_idx", DemographicStatistic.DEMOGRAPHIC_STATISTIC, new OrderField[] { DemographicStatistic.DEMOGRAPHIC_STATISTIC.GENDER }, false);
        public static Index DEMOGRAPHIC_STATISTIC_PKEY = createIndex("demographic_statistic_pkey", DemographicStatistic.DEMOGRAPHIC_STATISTIC, new OrderField[] { DemographicStatistic.DEMOGRAPHIC_STATISTIC.ID }, true);
        public static Index DEMOGRAPHIC_STATISTIC_TYPE_PKEY = createIndex("demographic_statistic_type_pkey", DemographicStatisticType.DEMOGRAPHIC_STATISTIC_TYPE, new OrderField[] { DemographicStatisticType.DEMOGRAPHIC_STATISTIC_TYPE.ID }, true);
        public static Index DEMOGRAPHIC_STATISTIC_TYPE_VARIANT_PKEY = createIndex("demographic_statistic_type_variant_pkey", DemographicStatisticTypeVariant.DEMOGRAPHIC_STATISTIC_TYPE_VARIANT, new OrderField[] { DemographicStatisticTypeVariant.DEMOGRAPHIC_STATISTIC_TYPE_VARIANT.DEMOGRAPHIC_STATISTIC_TYPE, DemographicStatisticTypeVariant.DEMOGRAPHIC_STATISTIC_TYPE_VARIANT.DEMOGRAPHIC_VARIANT }, true);
        public static Index DEMOGRAPHIC_VALUE_UNIT_PKEY = createIndex("demographic_value_unit_pkey", DemographicValueUnit.DEMOGRAPHIC_VALUE_UNIT, new OrderField[] { DemographicValueUnit.DEMOGRAPHIC_VALUE_UNIT.ID }, true);
        ...
        public static Index IMPACT_ESTIMATE_PKEY = createIndex("impact_estimate_pkey", ImpactEstimate.IMPACT_ESTIMATE, new OrderField[] { ImpactEstimate.IMPACT_ESTIMATE.ID }, true);
        public static Index IMPACT_ESTIMATE_INGREDIENT_PKEY = createIndex("impact_estimate_ingredient_pkey", ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT, new OrderField[] { ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT.ID }, true);
        public static Index IMPACT_ESTIMATE_INGREDIENT_RESPONSIBILITY_IMPACT_ESTIMATE_R_KEY = createIndex("impact_estimate_ingredient_responsibility_impact_estimate_r_key", ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT, new OrderField[] { ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT.RESPONSIBILITY, ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT.IMPACT_ESTIMATE_RECIPE, ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT.BURDEN_OUTCOME, ImpactEstimateIngredient.IMPACT_ESTIMATE_INGREDIENT.NAME }, true);
        public static Index IMPACT_ESTIMATE_RECIPE_PKEY = createIndex("impact_estimate_recipe_pkey", ImpactEstimateRecipe.IMPACT_ESTIMATE_RECIPE, new OrderField[] { ImpactEstimateRecipe.IMPACT_ESTIMATE_RECIPE.ID }, true);
        public static Index IMPACT_ESTIMATE_SET_PKEY = createIndex("impact_estimate_set_pkey", ImpactEstimateSet.IMPACT_ESTIMATE_SET, new OrderField[] { ImpactEstimateSet.IMPACT_ESTIMATE_SET.ID }, true);
        public static Index IMPACT_ESTIMATE_SET_INGREDIENT_PKEY = createIndex("impact_estimate_set_ingredient_pkey", ImpactEstimateSetIngredient.IMPACT_ESTIMATE_SET_INGREDIENT, new OrderField[] { ImpactEstimateSetIngredient.IMPACT_ESTIMATE_SET_INGREDIENT.ID }, true);
        public static Index IMPACT_OUTCOME_PKEY = createIndex("impact_outcome_pkey", ImpactOutcome.IMPACT_OUTCOME, new OrderField[] { ImpactOutcome.IMPACT_OUTCOME.ID }, true);
        public static Index MODEL_PKEY = createIndex("model_pkey", Model.MODEL, new OrderField[] { Model.MODEL.ID }, true);
        public static Index MODELLING_GROUP_DISEASE_UNIQUE_WHEN_CURRENT = createIndex("modelling_group_disease_unique_when_current", Model.MODEL, new OrderField[] { Model.MODEL.MODELLING_GROUP, Model.MODEL.DISEASE }, true);
        public static Index MODEL_RUN_PKEY = createIndex("model_run_pkey", ModelRun.MODEL_RUN, new OrderField[] { ModelRun.MODEL_RUN.INTERNAL_ID }, true);
        public static Index MODEL_RUN_PARAMETER_KEY_MODEL_RUN_PARAMETER_SET_KEY = createIndex("model_run_parameter_key_model_run_parameter_set_key", ModelRunParameter.MODEL_RUN_PARAMETER, new OrderField[] { ModelRunParameter.MODEL_RUN_PARAMETER.KEY, ModelRunParameter.MODEL_RUN_PARAMETER.MODEL_RUN_PARAMETER_SET }, true);
        public static Index MODEL_RUN_PARAMETER_PKEY = createIndex("model_run_parameter_pkey", ModelRunParameter.MODEL_RUN_PARAMETER, new OrderField[] { ModelRunParameter.MODEL_RUN_PARAMETER.ID }, true);
        public static Index MODEL_RUN_PARAMETER_SET_PKEY = createIndex("model_run_parameter_set_pkey", ModelRunParameterSet.MODEL_RUN_PARAMETER_SET, new OrderField[] { ModelRunParameterSet.MODEL_RUN_PARAMETER_SET.ID }, true);
        public static Index MODEL_RUN_PARAMETER_VALUE_MODEL_RUN_PARAMETER_MODEL_RUN_KEY = createIndex("model_run_parameter_value_model_run_parameter_model_run_key", ModelRunParameterValue.MODEL_RUN_PARAMETER_VALUE, new OrderField[] { ModelRunParameterValue.MODEL_RUN_PARAMETER_VALUE.MODEL_RUN_PARAMETER, ModelRunParameterValue.MODEL_RUN_PARAMETER_VALUE.MODEL_RUN }, true);
        public static Index MODEL_RUN_PARAMETER_VALUE_PKEY = createIndex("model_run_parameter_value_pkey", ModelRunParameterValue.MODEL_RUN_PARAMETER_VALUE, new OrderField[] { ModelRunParameterValue.MODEL_RUN_PARAMETER_VALUE.ID }, true);
        public static Index MODEL_VERSION_MODEL_VERSION_KEY = createIndex("model_version_model_version_key", ModelVersion.MODEL_VERSION, new OrderField[] { ModelVersion.MODEL_VERSION.MODEL, ModelVersion.MODEL_VERSION.VERSION }, true);
        public static Index MODEL_VERSION_PKEY = createIndex("model_version_pkey", ModelVersion.MODEL_VERSION, new OrderField[] { ModelVersion.MODEL_VERSION.ID }, true);
        public static Index MODELLING_GROUP_PKEY = createIndex("modelling_group_pkey", ModellingGroup.MODELLING_GROUP, new OrderField[] { ModellingGroup.MODELLING_GROUP.ID }, true);
        public static Index ONETIME_TOKEN_PKEY = createIndex("onetime_token_pkey", OnetimeToken.ONETIME_TOKEN, new OrderField[] { OnetimeToken.ONETIME_TOKEN.TOKEN }, true);
        public static Index PERMISSION_PKEY = createIndex("permission_pkey", Permission.PERMISSION, new OrderField[] { Permission.PERMISSION.NAME }, true);
        public static Index RESPONSIBILITY_PKEY = createIndex("responsibility_pkey", Responsibility.RESPONSIBILITY, new OrderField[] { Responsibility.RESPONSIBILITY.ID }, true);
        public static Index RESPONSIBILITY_RESPONSIBILITY_SET_SCENARIO_KEY = createIndex("responsibility_responsibility_set_scenario_key", Responsibility.RESPONSIBILITY, new OrderField[] { Responsibility.RESPONSIBILITY.RESPONSIBILITY_SET, Responsibility.RESPONSIBILITY.SCENARIO }, true);
        public static Index RESPONSIBILITY_SET_MODELLING_GROUP_TOUCHSTONE_KEY = createIndex("responsibility_set_modelling_group_touchstone_key", ResponsibilitySet.RESPONSIBILITY_SET, new OrderField[] { ResponsibilitySet.RESPONSIBILITY_SET.MODELLING_GROUP, ResponsibilitySet.RESPONSIBILITY_SET.TOUCHSTONE }, true);
        public static Index RESPONSIBILITY_SET_PKEY = createIndex("responsibility_set_pkey", ResponsibilitySet.RESPONSIBILITY_SET, new OrderField[] { ResponsibilitySet.RESPONSIBILITY_SET.ID }, true);
        public static Index RESPONSIBILITY_SET_STATUS_PKEY = createIndex("responsibility_set_status_pkey", ResponsibilitySetStatus.RESPONSIBILITY_SET_STATUS, new OrderField[] { ResponsibilitySetStatus.RESPONSIBILITY_SET_STATUS.ID }, true);
        public static Index ROLE_PKEY = createIndex("role_pkey", Role.ROLE, new OrderField[] { Role.ROLE.ID }, true);
        public static Index ROLE_PERMISSION_PKEY = createIndex("role_permission_pkey", RolePermission.ROLE_PERMISSION, new OrderField[] { RolePermission.ROLE_PERMISSION.ROLE, RolePermission.ROLE_PERMISSION.PERMISSION }, true);
        public static Index SCENARIO_PKEY = createIndex("scenario_pkey", Scenario.SCENARIO, new OrderField[] { Scenario.SCENARIO.ID }, true);
        public static Index SCENARIO_TOUCHSTONE_SCENARIO_DESCRIPTION_KEY = createIndex("scenario_touchstone_scenario_description_key", Scenario.SCENARIO, new OrderField[] { Scenario.SCENARIO.TOUCHSTONE, Scenario.SCENARIO.SCENARIO_DESCRIPTION }, true);
        public static Index SCENARIO_COVERAGE_SET_PKEY = createIndex("scenario_coverage_set_pkey", ScenarioCoverageSet.SCENARIO_COVERAGE_SET, new OrderField[] { ScenarioCoverageSet.SCENARIO_COVERAGE_SET.ID }, true);
        public static Index SCENARIO_DESCRIPTION_PKEY = createIndex("scenario_description_pkey", ScenarioDescription.SCENARIO_DESCRIPTION, new OrderField[] { ScenarioDescription.SCENARIO_DESCRIPTION.ID }, true);
        public static Index SUPPORT_TYPE_PKEY = createIndex("support_type_pkey", SupportType.SUPPORT_TYPE, new OrderField[] { SupportType.SUPPORT_TYPE.ID }, true);
        public static Index TOUCHSTONE_PKEY = createIndex("touchstone_pkey", Touchstone.TOUCHSTONE, new OrderField[] { Touchstone.TOUCHSTONE.ID }, true);
        public static Index TOUCHSTONE_TOUCHSTONE_NAME_VERSION_KEY = createIndex("touchstone_touchstone_name_version_key", Touchstone.TOUCHSTONE, new OrderField[] { Touchstone.TOUCHSTONE.TOUCHSTONE_NAME, Touchstone.TOUCHSTONE.VERSION }, true);
        public static Index TOUCHSTONE_COUNTRY_PKEY = createIndex("touchstone_country_pkey", TouchstoneCountry.TOUCHSTONE_COUNTRY, new OrderField[] { TouchstoneCountry.TOUCHSTONE_COUNTRY.ID }, true);
        public static Index TOUCHSTONE_DEMOGRAPHIC_DATASET_PKEY = createIndex("touchstone_demographic_dataset_pkey", TouchstoneDemographicDataset.TOUCHSTONE_DEMOGRAPHIC_DATASET, new OrderField[] { TouchstoneDemographicDataset.TOUCHSTONE_DEMOGRAPHIC_DATASET.ID }, true);
        public static Index TOUCHSTONE_DEMOGRAPHIC_SOURCE_PKEY = createIndex("touchstone_demographic_source_pkey", TouchstoneDemographicSource.TOUCHSTONE_DEMOGRAPHIC_SOURCE, new OrderField[] { TouchstoneDemographicSource.TOUCHSTONE_DEMOGRAPHIC_SOURCE.ID }, true);
        public static Index TOUCHSTONE_DEMOGRAPHIC_SOURCE_TOUCHSTONE_IDX = createIndex("touchstone_demographic_source_touchstone_idx", TouchstoneDemographicSource.TOUCHSTONE_DEMOGRAPHIC_SOURCE, new OrderField[] { TouchstoneDemographicSource.TOUCHSTONE_DEMOGRAPHIC_SOURCE.TOUCHSTONE }, false);
        public static Index TOUCHSTONE_NAME_PKEY = createIndex("touchstone_name_pkey", TouchstoneName.TOUCHSTONE_NAME, new OrderField[] { TouchstoneName.TOUCHSTONE_NAME.ID }, true);
        public static Index TOUCHSTONE_STATUS_PKEY = createIndex("touchstone_status_pkey", TouchstoneStatus.TOUCHSTONE_STATUS, new OrderField[] { TouchstoneStatus.TOUCHSTONE_STATUS.ID }, true);
        public static Index TOUCHSTONE_YEARS_PKEY = createIndex("touchstone_years_pkey", TouchstoneYears.TOUCHSTONE_YEARS, new OrderField[] { TouchstoneYears.TOUCHSTONE_YEARS.ID }, true);
        public static Index UPLOAD_INFO_PKEY = createIndex("upload_info_pkey", UploadInfo.UPLOAD_INFO, new OrderField[] { UploadInfo.UPLOAD_INFO.ID }, true);
