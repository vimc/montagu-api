...
public class BurdenEstimateStochastic extends TableImpl<BurdenEstimateStochasticRecord> {
    ...
    private static final long serialVersionUID = -1334963759;
    ...
    public BurdenEstimateStochastic() {
        this("burden_estimate_stochastic", null);
    }
    ...
    private BurdenEstimateStochastic(String alias, Table<BurdenEstimateStochasticRecord> aliased) {
        this(alias, aliased, null);
    }

    private BurdenEstimateStochastic(String alias, Table<BurdenEstimateStochasticRecord> aliased, Field<?>[] parameters) {
