...
public class Gender extends TableImpl<GenderRecord> {
    ...
    private static final long serialVersionUID = 334663005;
     ...
     */
    public final TableField<GenderRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false), this, "");
