...
public class BurdenEstimateSetType extends TableImpl<BurdenEstimateSetTypeRecord> {
    ...
    private static final long serialVersionUID = -630459898;
    ...
    public BurdenEstimateSetType() {
        this("burden_estimate_set_type", null);
    }
    ...
    private BurdenEstimateSetType(String alias, Table<BurdenEstimateSetTypeRecord> aliased) {
        this(alias, aliased, null);
    }

    private BurdenEstimateSetType(String alias, Table<BurdenEstimateSetTypeRecord> aliased, Field<?>[] parameters) {
