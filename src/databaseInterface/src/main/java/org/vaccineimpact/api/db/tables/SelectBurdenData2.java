...
public class SelectBurdenData2 extends TableImpl<SelectBurdenData2Record> {
    ...
    private static final long serialVersionUID = -1613776558;
    ...
    private SelectBurdenData2(String alias, Table<SelectBurdenData2Record> aliased) {
        this(alias, aliased, new Field[4]);
    }

    private SelectBurdenData2(String alias, Table<SelectBurdenData2Record> aliased, Field<?>[] parameters) {
    ...
    public SelectBurdenData2 call(Integer set1, Integer outcome1, Integer set2, Integer outcome2) {
        return new SelectBurdenData2(getName(), null, new Field[] { DSL.val(set1), DSL.val(outcome1), DSL.val(set2), DSL.val(outcome2) });
    }
    ...
    public SelectBurdenData2 call(Field<Integer> set1, Field<Integer> outcome1, Field<Integer> set2, Field<Integer> outcome2) {
        return new SelectBurdenData2(getName(), null, new Field[] { set1, outcome1, set2, outcome2 });
    }
}
