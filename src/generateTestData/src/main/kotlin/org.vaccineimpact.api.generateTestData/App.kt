...
fun main(args: Array<String>)
{
    JooqContext().use { db ->
        ...
        db.generateCoverageData(yfNoVacc, countryCount = 196, yearRange = 1900..2021, ageRange = 0..0)
        db.generateCoverageData(yfRoutineWithout, countryCount = 196, yearRange = 1900..2021, ageRange = 0..0)
        db.generateCoverageData(yfRoutineWith, countryCount = 196, yearRange = 1900..2021, ageRange = 0..0)
        ...
        db.addModel("YF-Model", "IC-Garske", "YF", "Yellow Fever model", versions = listOf("1"))
        db.addUserForTesting("testing")
