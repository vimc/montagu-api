...
public class BurdenEstimateRecord extends UpdatableRecordImpl<BurdenEstimateRecord> implements Record7<Integer, Integer, String, Integer, Integer, Boolean, Double> {

    private static final long serialVersionUID = 762094106;
     ...
     */
    @Override
    public Row7<Integer, Integer, String, Integer, Integer, Boolean, Double> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, Integer, String, Integer, Integer, Boolean, Double> valuesRow() {
     ...
     */
    @Override
    public BurdenEstimateRecord value7(Double value) {
        setValue(value);
        return this;
    }
     ...
     */
    @Override
    public BurdenEstimateRecord values(Integer value1, Integer value2, String value3, Integer value4, Integer value5, Boolean value6, Double value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BurdenEstimateRecord(Integer id, Integer burdenEstimateSet, String country, Integer year, Integer outcome, Boolean stochastic, Double value) {
        super(BurdenEstimate.BURDEN_ESTIMATE);
