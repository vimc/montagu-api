...
public class Vaccine extends TableImpl<VaccineRecord> {
    ...
    private static final long serialVersionUID = -2108769791;
    ...
    private Vaccine(String alias, Table<VaccineRecord> aliased) {
        this(alias, aliased, null);
    }

    private Vaccine(String alias, Table<VaccineRecord> aliased, Field<?>[] parameters) {
