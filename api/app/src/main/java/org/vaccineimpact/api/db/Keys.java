...
public class Keys {
    ...
    public static final UniqueKey<VaccinationLevelRecord> VACCINATION_LEVEL_PKEY = UniqueKeys0.VACCINATION_LEVEL_PKEY;
    ...
    public static final ForeignKey<BurdenEstimateSetRecord, UserRecord> BURDEN_ESTIMATE_SET__BURDEN_ESTIMATE_SET_UPLOADED_BY_FKEY = ForeignKeys0.BURDEN_ESTIMATE_SET__BURDEN_ESTIMATE_SET_UPLOADED_BY_FKEY;
    ...
    public static final ForeignKey<CoverageSetRecord, VaccinationLevelRecord> COVERAGE_SET__COVERAGE_SET_VACCINATION_LEVEL_FKEY = ForeignKeys0.COVERAGE_SET__COVERAGE_SET_VACCINATION_LEVEL_FKEY;
    public static final ForeignKey<CoverageSetRecord, ScenarioTypeRecord> COVERAGE_SET__COVERAGE_SET_SCENARIO_TYPE_FKEY = ForeignKeys0.COVERAGE_SET__COVERAGE_SET_SCENARIO_TYPE_FKEY;
    ...
    public static final ForeignKey<ScenarioDescriptionRecord, VaccinationLevelRecord> SCENARIO_DESCRIPTION__SCENARIO_DESCRIPTION_VACCINATION_LEVEL_FKEY = ForeignKeys0.SCENARIO_DESCRIPTION__SCENARIO_DESCRIPTION_VACCINATION_LEVEL_FKEY;
    ...
    public static final ForeignKey<ScenarioDescriptionRecord, VaccineRecord> SCENARIO_DESCRIPTION__SCENARIO_DESCRIPTION_VACCINE_FKEY = ForeignKeys0.SCENARIO_DESCRIPTION__SCENARIO_DESCRIPTION_VACCINE_FKEY;
    ...
    public static final ForeignKey<UserRoleRecord, UserRecord> USER_ROLE__USER_ROLE_USERNAME_FKEY = ForeignKeys0.USER_ROLE__USER_ROLE_USERNAME_FKEY;
    ...
    private static class UniqueKeys0 extends AbstractKeys {
        ...
        public static final UniqueKey<ScenarioTypeRecord> SCENARIO_TYPE_PKEY = createUniqueKey(ScenarioType.SCENARIO_TYPE, "scenario_type_pkey", ScenarioType.SCENARIO_TYPE.ID);
        ...
        public static final UniqueKey<VaccinationLevelRecord> VACCINATION_LEVEL_PKEY = createUniqueKey(VaccinationLevel.VACCINATION_LEVEL, "vaccination_level_pkey", VaccinationLevel.VACCINATION_LEVEL.ID);
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        ...
        public static final ForeignKey<BurdenEstimateSetRecord, UserRecord> BURDEN_ESTIMATE_SET__BURDEN_ESTIMATE_SET_UPLOADED_BY_FKEY = createForeignKey(org.vaccineimpact.api.db.Keys.USER_PKEY, BurdenEstimateSet.BURDEN_ESTIMATE_SET, "burden_estimate_set__burden_estimate_set_uploaded_by_fkey", BurdenEstimateSet.BURDEN_ESTIMATE_SET.UPLOADED_BY);
        ...
        public static final ForeignKey<CoverageSetRecord, VaccinationLevelRecord> COVERAGE_SET__COVERAGE_SET_VACCINATION_LEVEL_FKEY = createForeignKey(org.vaccineimpact.api.db.Keys.VACCINATION_LEVEL_PKEY, CoverageSet.COVERAGE_SET, "coverage_set__coverage_set_vaccination_level_fkey", CoverageSet.COVERAGE_SET.VACCINATION_LEVEL);
        public static final ForeignKey<CoverageSetRecord, ScenarioTypeRecord> COVERAGE_SET__COVERAGE_SET_SCENARIO_TYPE_FKEY = createForeignKey(org.vaccineimpact.api.db.Keys.SCENARIO_TYPE_PKEY, CoverageSet.COVERAGE_SET, "coverage_set__coverage_set_scenario_type_fkey", CoverageSet.COVERAGE_SET.SCENARIO_TYPE);
        ...
        public static final ForeignKey<ScenarioDescriptionRecord, VaccinationLevelRecord> SCENARIO_DESCRIPTION__SCENARIO_DESCRIPTION_VACCINATION_LEVEL_FKEY = createForeignKey(org.vaccineimpact.api.db.Keys.VACCINATION_LEVEL_PKEY, ScenarioDescription.SCENARIO_DESCRIPTION, "scenario_description__scenario_description_vaccination_level_fkey", ScenarioDescription.SCENARIO_DESCRIPTION.VACCINATION_LEVEL);
        ...
        public static final ForeignKey<ScenarioDescriptionRecord, VaccineRecord> SCENARIO_DESCRIPTION__SCENARIO_DESCRIPTION_VACCINE_FKEY = createForeignKey(org.vaccineimpact.api.db.Keys.VACCINE_PKEY, ScenarioDescription.SCENARIO_DESCRIPTION, "scenario_description__scenario_description_vaccine_fkey", ScenarioDescription.SCENARIO_DESCRIPTION.VACCINE);
        public static final ForeignKey<ScenarioDescriptionRecord, ScenarioTypeRecord> SCENARIO_DESCRIPTION__SCENARIO_DESCRIPTION_SCENARIO_TYPE_FKEY = createForeignKey(org.vaccineimpact.api.db.Keys.SCENARIO_TYPE_PKEY, ScenarioDescription.SCENARIO_DESCRIPTION, "scenario_description__scenario_description_scenario_type_fkey", ScenarioDescription.SCENARIO_DESCRIPTION.SCENARIO_TYPE);
        ...
        public static final ForeignKey<UserRoleRecord, UserRecord> USER_ROLE__USER_ROLE_USERNAME_FKEY = createForeignKey(org.vaccineimpact.api.db.Keys.USER_PKEY, UserRole.USER_ROLE, "user_role__user_role_username_fkey", UserRole.USER_ROLE.USERNAME);
