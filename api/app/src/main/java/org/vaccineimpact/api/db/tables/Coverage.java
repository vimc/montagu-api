...
public class Coverage extends TableImpl<CoverageRecord> {
    ...
    private static final long serialVersionUID = -848988003;
     ...
     */
    public final TableField<CoverageRecord, Integer> AGE_FROM = createField("age_from", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.coverage.age_to</code>.
     */
    public final TableField<CoverageRecord, Integer> AGE_TO = createField("age_to", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.coverage.percentage_coverage</code>.
     */
    public final TableField<CoverageRecord, BigDecimal> PERCENTAGE_COVERAGE = createField("percentage_coverage", org.jooq.impl.SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>public.coverage.gavi_support</code>.
     */
    public final TableField<CoverageRecord, Boolean> GAVI_SUPPORT = createField("gavi_support", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");

    /**
     * The column <code>public.coverage.activity</code>.
     */
    public final TableField<CoverageRecord, String> ACTIVITY = createField("activity", org.jooq.impl.SQLDataType.CLOB, this, "");
